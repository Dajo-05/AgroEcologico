...
import com.example.agroecologico.databinding.FragmentListadoCompraBinding
...
class ListadoCompraFragment : Fragment(), AdapterCompNegocio.onItemClikListener {

    private lateinit var mBinding: FragmentListadoCompraBinding
    ...
    override fun onCreateView(
        ...
        auth= Firebase.auth
        mBinding= FragmentListadoCompraBinding.inflate(inflater, container, false)
    ...
    private fun cargaDatos() {
        mBinding.carga2.visibility = View.VISIBLE
        ...
        database.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                adaptador = AdapterCompNegocio(ListaNegocio, this@ListadoCompraFragment)
                mLayoutManager = LinearLayoutManager(context)
                mBinding.rvNegocios2.apply {
                    layoutManager = mLayoutManager
                    adapter = adaptador

                }
                mBinding.carga2.visibility = View.GONE
            }
    ...
    fun VerProductos(posicion: Int){
        ...
        val fragmentoListado = CarritoCompraFragment()
